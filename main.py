...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if '/start' in msgText:
            start_msg = 'Bot          : RayServer UnOficial Bot\n'
            start_msg+= 'Desarrollador: @raydel0307\n'
            ...
            #    bot_token = '5885597162:AAFfylEaclFuUHDRa8S7GZAzh65-VrmFPPk'
...
def main():
    ...
    #set in debug
    print('Init RayServer')
    bot_token = '5885597162:AAFfylEaclFuUHDRa8S7GZAzh65-VrmFPPk'
    bot = ObigramClient(bot_token)
    bot.onMessage(onmessage)
    bot.sendMessage(1702380015,'⚠️ Reiniciado ...')
    bot.run()
